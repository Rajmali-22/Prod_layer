...
# Trim what is actually sent to the LLM to the last 10 exchanges
# (up to 20 messages: user+assistant pairs).
MAX_HISTORY_SENT_TO_LLM = 10
...
# Modes that should NOT use long-lived conversation memory.
# We skip:
